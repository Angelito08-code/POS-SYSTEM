...
def get_db_connection():
    ...
    if not database_url:
        database_url = os.environ.get("postgresql://postgres:IzoMeELhcSr4Uhq5@db.ylwczrmidyndkvhgnblg.supabase.co:5432/postgres") or os.environ.get("postgresql://postgres:IzoMeELhcSr4Uhq5@db.ylwczrmidyndkvhgnblg.supabase.co:5432/postgres")
